...
--
SELECT substring_index("nguyễn văn khoa", " ", 1); -- lấy chuỗi từ "dấu cách" "thứ 1" từ trái qua XXX xem xét lại
SELECT substring_index("nguyễn văn khoa", " ", -1); -- lấy chuỗi từ "dấu cách" "thứ 1" từ phải qua
